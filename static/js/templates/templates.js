...
output += runtime.suppressValue((lineno = 5, colno = 73, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "urlencode"), "urlencode", [runtime.contextOrFrameLookup(context, frame, "url")])), env.autoesc);
output += "&description=";
...
output += runtime.suppressValue((lineno = 8, colno = 57, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "urlencode"), "urlencode", [runtime.contextOrFrameLookup(context, frame, "url")])), env.autoesc);
output += "\" target=\"_blank\" rel=\"nofollow\" title=\"Share this fiddle\">\n        <i class=\"fa fa-google-plus-square mm-share-btn mm-share-btn--google-plus\"></i>\n    </a>\n    <a href=\"http://www.linkedin.com/shareArticle?url=";
output += runtime.suppressValue((lineno = 11, colno = 64, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "urlencode"), "urlencode", [runtime.contextOrFrameLookup(context, frame, "url")])), env.autoesc);
output += "&title=";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "encoded_desc"), env.autoesc);
output += "\" target=\"_blank\" rel=\"nofollow\" title=\"Share this fiddle\">\n        <i class=\"fa fa-linkedin-square mm-share-btn mm-share-btn--linked-in\"></i>\n    </a>\n    <a href=\"http://www.stumbleupon.com/submit?url=";
output += runtime.suppressValue((lineno = 14, colno = 61, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "urlencode"), "urlencode", [runtime.contextOrFrameLookup(context, frame, "url")])), env.autoesc);
output += "&title=";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "encoded_desc"), env.autoesc);
